	...
	$.ajax({
		...
		success:function(data){
			if(data.delResult == "true"){//删除成功：移除删除行
				...
				window.location.href=path+"/user/userlist.html";
		...
		$.ajax({
			...
			success:function(result){
				if("failed" == result){
					...
					if(result.idPicPath!=null){
						$("#v_idPicPath").attr('src',"/SMBMS-NEW/statics/uploadfiles/"+result.idPicPath);
					}
					if(result.workPicPath!=null){
						$("#v_workPicPath").attr('src',"/SMBMS-NEW/statics/uploadfiles/"+result.workPicPath);
					}
				}
			},
			error:function(){
